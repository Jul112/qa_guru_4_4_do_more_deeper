...
public class StudentRegistrationFormTests {
    StudentRegistrationPage studentRegistrationPage; //объъявление
    ...
    void successfulFillFormTest() {
        StudentRegistrationPage studentRegistrationPage = new StudentRegistrationPage(); //инициализация
        open("https://demoqa.com/automation-practice-form");
        studentRegistrationPage.checkPageHeader("Student Registration Form"); //= $(".practice-form-wrapper").shouldHave(text("Student Registration Form"));

        studentRegistrationPage.setFirstName(firstName);//=$("#firstName").val(firstName);
